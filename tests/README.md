...
- [x] **Message thread unread count E2E** — Incoming SMS and missed calls increment the unread count, the existing thread update endpoint resets it, outbound activity preserves it, and deleting an unread item decrements it
