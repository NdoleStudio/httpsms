    ...
    <v-container class="mt-16">
      <v-row>
        <v-col cols="10" offset="1" class="mt-8">
          <h1 class="text-h4 font-weight-bold mb-4">Terms and Conditions</h1>
          <p>
            By downloading or using the app and using the HTTP SMS service,
          ...
          <p>
            ...
            phone’s security features and it could mean that the HTTP SMS app
          ...
          <p>
            ...
            but Ndole Studio cannot take responsibility for the app not working
          ...
          <p>
            ...
            it on to avail the Service, Ndole Studio cannot accept
            responsibility.
          </p>
          <p>
            With respect to Ndole Studio’s responsibility for your use of the
          ...
          <p>
            ...
            to keep using the app. Ndole Studio does not promise that it will
          ...
          <p>These terms and conditions are effective as of 2022-10-09</p>
